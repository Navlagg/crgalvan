...
function displayRandomCard() {
    ...
    $players[0] = new Student("Jack", 1);
    $players[1] = new Student("Jill", 2);
    $players[2] = new Student("John", 3);
    $players[3] = new Student("Jane", 4);
...
<html lang="en">
    ...
    <body>
        ...
        <div id="top">
            SilverJack
            <a style="font-size: .3em">by Otters</a>
        </div>
    
        
     
        <div id="main">
            <?php displayRandomCard() ?>
        </div>
        
        
        </br>
        
        <audio src='https://hydra-media.cursecdn.com/dota2.gamepedia.com/a/a5/Multicast_x4.mp3' autoplay> </audio>
